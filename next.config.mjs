        ...
        headers: [
          ...
          { key: 'Referrer-Policy', value: 'strict-origin-when-cross-origin' },
          {
            ...
            value: [
              ...
              `img-src 'self' data: blob: ${SUPABASE_ORIGIN} https://*.cdninstagram.com https://i.ytimg.com`,
              `media-src 'self' blob: ${SUPABASE_ORIGIN} https://*.cdninstagram.com`,
              `connect-src 'self' ${SUPABASE_ORIGIN} wss://${SUPABASE_HOST} https://*.cdninstagram.com`,
              "frame-src https://www.instagram.com https://www.youtube.com https://www.youtube-nocookie.com",
